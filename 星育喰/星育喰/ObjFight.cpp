...
void CObjFight::Action()
{
	...
	if (m_end_f == true)
	{
		...
		{					
			CObjFightClear* crer = new CObjFightClear(2000, 20, L"木材", &g_Wood_num, 80, 1);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
		//左から２番目
		if (g_Challenge_enemy == 1)									
		{				
			CObjFightClear* crer = new CObjFightClear(10000, 60, L"銀", &g_Silver_num, 50, L"木材", &g_Wood_num, 60, 0);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
		//左から３番目
		if (g_Challenge_enemy == 2)									
		{
			CObjFightClear* crer = new CObjFightClear(15000, 80, L"木材", &g_Wood_num, 80, 0);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
		//左から４番目
		if (g_Challenge_enemy == 3)									
		{
			CObjFightClear* crer = new CObjFightClear(3000, 30, L"銀", &g_Silver_num, 50, L"木材", &g_Wood_num, 60, 0);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
		//ボス
		if (g_Challenge_enemy == 4)									
		{
			CObjFightClear* crer = new CObjFightClear(1000, 20, L"木材", &g_Wood_num, 80, 2);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
	}
}
