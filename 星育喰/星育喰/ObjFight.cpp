...
void CObjFight::Action()
{
	...
	if (m_end_f == true)
	{
		...
		{					
			CObjFightClear* crer = new CObjFightClear(3000, 100, L"木材", &g_Wood_num, 50, L"鉄", &g_Iron_num, 30, 2);
		...
		{
			CObjFightClear* crer = new CObjFightClear(5000, 150, L"鉄", &g_Iron_num, 70, L"アルミ", &g_Aluminum_num, 80, 3);
			Objs::InsertObj(crer, OBJ_FIGHT_CLEAR, 15);
		}
		//ボス
