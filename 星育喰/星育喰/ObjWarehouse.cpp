...
void CObjWarehouse::Draw()
{
	...
	else if (window_start_manage == Materials)
	{
		...
		//資材文字表示
		Font::StrDraw(L"資材", 500.0f, 110.0f, 50.0f, black);
		...
		Font::StrDraw(L"木材", 300.0f, 400.0f,40.0f, black);
		Font::StrDraw(mrl[0], 300.0f, 500.0f, 40.0f, black);
		...
		Font::StrDraw(L"鉄", 825.0f, 400.0f, 40.0f, black);
		Font::StrDraw(mrl[1], 825.0f, 500.0f, 40.0f, black);
