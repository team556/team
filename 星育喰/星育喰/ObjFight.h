...
protected:
	...
	static float Pla_One_pat_dem[3];	//プレイヤーのワンパターンデメリット値管理配列[0:上レーン　1:中レーン　2:下レーン][変動値は1.0～0.5の6段階。レーンで撃つ度に0.1ずつ減少。他のレーンを撃つ度に0.1ずつ回復。][この値が攻撃力と乗算され、最終的な攻撃力となる]
	static float Ene_One_pat_dem[3];	//エネミ－のワンパターンデメリット値管理配列[0:上レーン　1:中レーン　2:下レーン][変動値は1.0～0.5の6段階。レーンで撃つ度に0.1ずつ減少。他のレーンを撃つ度に0.1ずつ回復。][この値が攻撃力と乗算され、最終的な攻撃力となる]
