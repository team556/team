...
int g_Bar_Level = 3;
int g_Ins_Level = 3;
int g_Mis_Recast_Level		= 3;
int g_Pow_equip_Level		= 3;
int g_Pow_equip_Lv_achieve	= 2;
int g_Def_equip_Level		= 2;
int g_Def_equip_Lv_achieve	= 2;
int g_Spe_equip_Level		= 2;
int g_Spe_equip_Lv_achieve	= 2;
int g_Bal_equip_Level		= 3;
int g_Bal_equip_Lv_achieve	= 3;
int g_Pod_equip_Level		= 2;
int g_Pod_equip_Lv_achieve	= 2;
float g_Player_max_size = 150.0f;//100.0f;
int g_Special_equipment = 4;//装備中のスペシャル技
bool g_Special_mastering[5] = { false,false,false,true,false };//スペシャル技の習得状態
int g_Power_num		= 2500;
int g_Defense_num	= 2500;
int g_Speed_num		= 2500;
int g_Balance_num	= 2500;
int g_Research_num	= 6000;
int g_Remain_num	= 0;
...
int g_Challenge_enemy = 4;//デバッグ。0に戻すべし。
bool g_help_f = false;
